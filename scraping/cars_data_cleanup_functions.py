...
def pre_eda_car_df():
    audi = car_df_cleanup(pd.read_csv("scraping/data/audi_full.csv")).reset_index(drop=True)
    bmw = car_df_cleanup(pd.read_csv("scraping/data/bmw_full.csv")).reset_index(drop=True)
    mercedes = car_df_cleanup(pd.read_csv("scraping/data/mercedes_full.csv")).reset_index(drop=True)
